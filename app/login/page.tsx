      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <a href="/" className="inline-block mb-5">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-gold-500/20 to-gold-600/5 border border-gold-500/20">
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="flex items-start gap-3 pt-1">
                  ...
                  <label htmlFor="reg-terms" className="text-ink-400 text-xs leading-relaxed cursor-pointer">
                    I agree to the{' '}
                    <a href="/terms" className="text-gold-400/80 hover:text-gold-300 underline underline-offset-2">
                      Terms of Service
                    </a>{' '}
                    and{' '}
        ...
        <div className="mt-8 text-center space-y-2">
          ...
          <div className="flex items-center justify-center gap-4 text-xs">
            <a
              href="/terms"
              className="text-ink-500 hover:text-ink-300 transition-colors underline underline-offset-2"
            >
              Terms
            </a>
